...
This command runs minimap2 and realigns the initial reads to the assembly assembled by flye.
...
- `--memory-mapping` stops kraken2 from trying to load the complete database into the memory (wouldn't work without this)
